...
| Docker-backed | `io.github.wboult.es-runner.docker-shared-test-clusters` | shared Elasticsearch or OpenSearch container via Testcontainers | `samples/docker-shared-cluster-multiproject-sample/` and `samples/docker-opensearch-shared-cluster-multiproject-sample/` |
...
2. Read the backend-specific how-to while wiring the build.
...
- Docker-backed Elasticsearch sample:
  `samples/docker-shared-cluster-multiproject-sample/`
- Docker-backed OpenSearch sample:
