...
4. Verify:
   ...
   - the sample build in `samples/gradle-shared-cluster-multiproject-sample/` works
...
The checked-in sample at `samples/gradle-shared-cluster-multiproject-sample/` is the
