# Multi-project Docker shared-cluster sample
...
Elasticsearch 9 container can support multiple projects and suites without
data collisions.

It proves:

- one shared Elasticsearch 9 container per build
...
All four suites share one Elasticsearch container, but they use different
