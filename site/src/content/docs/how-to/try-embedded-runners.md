---
title: Try embedded runners
description: Run the experimental in-JVM Elasticsearch and OpenSearch modules locally.
sidebar:
  order: 12
---
...
[Embedded JVM search servers](https://github.com/wboult/es-runner/blob/main/docs/embedded-jvm-server.md).

## Related

- [Compatibility & support policy](../../reference/compatibility/)
